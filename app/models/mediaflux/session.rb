...
module Mediaflux
  class Session
    ...
    def initialize(use_ssl: false, http_client: nil)
      @http_client = http_client || Request.build_http_client
      @http_client.use_ssl = use_ssl
    end

    def logon
      logon_request = LogonRequest.new(http_client: @http_client)
    ...
    def collections
      ...
      collection_list_request = CollectionListRequest.new(http_client: @http_client, session_token: @token)
