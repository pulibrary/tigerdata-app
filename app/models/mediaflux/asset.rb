...
module Mediaflux
  class Asset
    attr_accessor :id, :path, :collection, :size, :collection_count, :file_count, :folder_size, :type
    ...
    # Returns the default local time zone used for converting Mediaflux dates to ISO 8601 format.
    # @return [String] the default local time zone used for converting Mediaflux dates to ISO 8601 format
    def default_local_time_zone
      "America/New_York"
    end
    ...
    def path_only
      return nil if path.nil?
      return path_short if collection?
