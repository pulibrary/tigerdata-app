...
RSpec.describe "new-project/additional-info-related-resources", type: :request do
  ...
  describe "GET" do
    ...
    context "when the client is authenticated" do
      ...
      it "renders a successful response" do
        sign_in user
        get new_project_additional_information_related_resources_url(request.id)
  ...
  describe "PUT /save" do
    it "redirects the client to the sign in path" do
      put new_project_additional_information_related_resources_save_url(request_id: 1)
    ...
    context "when the client is authenticated" do
      ...
      context "the request exists" do
        ...
        it "renders a successful response for a next commit" do
          sign_in user
          put new_project_additional_information_related_resources_save_url(request.id, request: { request_title: "new title", project_title: "new project" }, commit: "Next")
        ...
        it "renders a successful response for a back commit" do
          sign_in user
          put new_project_additional_information_related_resources_save_url(request.id, request: { request_title: "new title", project_title: "new project" }, commit: "Back")
