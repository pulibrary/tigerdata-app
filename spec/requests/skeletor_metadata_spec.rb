...
RSpec.describe "The Skeletor Metadata", connect_to_mediaflux: true, metadata: true, type: :request do
  let(:data_manager) {
 FactoryBot.create(:data_manager, uid: "pp9425", mediaflux_session: SystemUser.mediaflux_session) }
  let(:data_sponsor) {
 FactoryBot.create(:project_sponsor, uid: "rl3667", mediaflux_session: SystemUser.mediaflux_session) }
