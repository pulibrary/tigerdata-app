...
require_relative("support/inconsistent_spec_formatter")
...
RSpec.configure do |config|
  ...
  # Add reporting for inconsistently-failing tests only on CI
  if ENV["CI"]
    config.add_formatter(InconsistentSpecFormatter, $stdout)
  end
end
