...
RSpec.describe Mediaflux::AssetMetadataRequest, type: :model do
  ...
  describe "#metadata" do
    ...
    context "actual mediaflux connection", connect_to_mediaflux: true do
      ...
      after do
        Mediaflux::AssetDestroyRequest.new(session_token: current_user.mediaflux_session, collection: valid_project.mediaflux_id, members: true).resolve
      end
