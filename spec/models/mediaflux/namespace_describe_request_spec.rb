...
RSpec.describe Mediaflux::NamespaceDescribeRequest, connect_to_mediaflux: true, type: :model do
  ...
  describe "#metadata" do
    before do
      namespace_list_req = Mediaflux::NamespaceListRequest.new(session_token: user.mediaflux_session, 
parent_namespace: "/princeton")
    ...
    it "parses a metadata response", :integration do
      namespace_request = described_class.new(session_token: user.mediaflux_session, 
id: @tigerdata_ns.attributes["id"].value)
