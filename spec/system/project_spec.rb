...
#TO-DO: change project so it has no data user
# look at meta data at the top to see how to set the data user to empty (line 9)
# show.html.erb --> changes to be made


#setting metadata to be empty: 
