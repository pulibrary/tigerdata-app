...
RSpec.describe "WelcomeController", stub_mediaflux: true, js: true do
  ...
  context "authenticated user" do
    ...
    before do
      FactoryBot.create(:project_with_metadata, data_sponsor: current_user.uid, data_manager: other_user.uid, title: "project 111")
      FactoryBot.create(:project_with_metadata, data_sponsor: other_user.uid, data_manager: current_user.uid, title: "project 222")
      FactoryBot.create(:project_with_metadata, data_sponsor: other_user.uid, data_manager: other_user.uid, ro_users: [current_user.uid], title: "project 333")
      FactoryBot.create(:project_with_metadata, data_sponsor: other_user.uid, data_manager: other_user.uid, title: "project 444")
    end
