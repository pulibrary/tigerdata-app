...
FactoryBot.define do
  # TODO: we should either remove this so we don't write the metadata hash value
  # directly and instead always use our new and shiny metadata_model.
  # We will remove this once all other tests have been updated to use metadata_model.
  factory :project, class: "Project" do
    ...
    factory :project_with_metadata, class: "Project" do
      transient do
        data_sponsor { FactoryBot.create(:project_sponsor).uid }
        data_manager { FactoryBot.create(:data_manager).uid }
        ro_users { [] }
